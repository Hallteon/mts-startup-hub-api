# Generated by Django 3.2.9 on 2022-10-08 14:28
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=200, verbose_name='Стадия разработки')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('application_plan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='startups.applicationprogram', verbose_name='Программа')),
